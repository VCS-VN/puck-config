    ...
    if (typeof t != "string" && !Array.isArray(t)) {
      for (const n in t)
        if (n !== "default" && !(n in c)) {
          ...
          a && Object.defineProperty(c, n, a.get ? a : {
            enumerable: !0,
            get: () => t[n]
          });
        }
...
(function() {
  ...
  const s = (e, o) => {
    e.focus(), e.undoManager.transact(() => {
      e.setContent(o);
    }), e.selection.setCursorLocation(), e.nodeChanged();
  }, r = (e) => e.getContent({ source_view: !0 }), t = (e) => {
    const o = r(e);
...
//# sourceMappingURL=index-Sagq-meT.js.map
